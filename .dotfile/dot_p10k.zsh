# Generated by Powerlevel10k configuration wizard on 2023-12-20 at 14:22 +07.
# Based on romkatv/powerlevel10k/config/p10k-pure.zsh, checksum 35142.
# Wizard options: awesome-fontconfig + powerline, small icons, pure, 24h time, 1 line,
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_INCOMING_CHANGES_ICON="%F{$red}⇣"
  # Show '⇡' if local branch is ahead of remote.
  typeset -g POWERLEVEL9K_VCS_OUTGOING_CHANGES_ICON="%F{$red}⇡"
  ...
  # Show fractional seconds. Thus, 7.2s rather than 7s.
